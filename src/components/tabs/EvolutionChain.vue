...
<template>
  <div class="chain">
    <div class="from">
      ...
      <img
        class="pokemon"
        :src="pokemonsStore.getSpriteByName(chain.species.name)"
      />
    ...
    <div class="method">
      ...
      <span
        >Level {{ chain.evolves_to[0].evolution_details[0].min_level }}</span
      >
    </div>
    <div class="to">
      <img
        class="pokemon"
        :src="
          pokemonsStore.getSpriteByName(props.chain.evolves_to[0].species.name)
        "
      />

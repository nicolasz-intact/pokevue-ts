...
<template>
    <div class="container" v-if="pokemon" :style="{ backgroundColor: POKEMON_TYPE_COLORS[pokemon?.types[0].type.name] }">
        <div class="rectangle"></div>
        <div class="dotted"><img src="@/assets/icons/dotted.svg/"></div>
        <div class="pokemon-details">
            <div class="pokemon-general">
                <h1 class="capitalize">{{ pokemon.name }} <span>#{{ pokemonsStore.getPokemonId(pokemon.id) }}</span>
                </h1>
